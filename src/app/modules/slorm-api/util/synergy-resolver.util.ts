...
export function isExternalSynergyResolveData(resolveData: SynergyResolveData | ExternalSynergyResolveData): resolveData is ExternalSynergyResolveData {
    return resolveData.type === ResolveDataType.ExternalSynergy
}
