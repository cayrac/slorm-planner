    ...
    private readonly CHANGES: Array<{ version: string, update: (build: Build) => void }> = [
        ...
        },
        {
            ...
            update: build => {
                ...
                build.configuration.unity_level_0_47_p = 0;
                build.configuration.unity_level_0_48_p = 0;
                build.configuration.unity_level_0_49_p = 0;
                build.configuration.unity_level_0_50_p = 0;
                build.configuration.unity_level_0_51_p = 0;
                build.configuration.unity_level_0_52_p = 0;
                build.configuration.unity_level_1_47_p = 0;
                build.configuration.unity_level_1_48_p = 0;
                build.configuration.unity_level_1_49_p = 0;
                build.configuration.unity_level_1_50_p = 0;
                build.configuration.unity_level_1_51_p = 0;
                build.configuration.unity_level_1_52_p = 0;
                build.configuration.unity_level_2_47_p = 0;
                build.configuration.unity_level_2_48_p = 0;
                build.configuration.unity_level_2_49_p = 0;
