...
function addConstant(effect: ReaperEffect | null, value: number, percent: boolean, valueType: EffectValueValueType, stat: string | null = null) {
    if (effect !== null) {
        effect.values.push({
            ...
            value: 2,
            percent: false,
            valueType: EffectValueValueType.AreaOfEffect,
            stat: 'vindictive_slam_reaper_effect_radius'
...
export const DATA_REAPER: { [key: number]: DataReaper } = {
    ...
    60: {
        override: (ba, be, ma) => {
            overrideValueTypeAndStat(ba, 0, EffectValueValueType.Stat, 'projectile_skill_weapon_damage_mult');
            overrideValueTypeAndStat(ba, 1, EffectValueValueType.Stat, 'projectile_skill_armor_penetration');
            overrideValueTypeAndStat(ba, 2, EffectValueValueType.Stat, 'projectile_skill_elemental_penetration');
    ...
    75: {
        override: (ba, be, ma) => {
            overrideValueTypeAndStat(ba, 0, EffectValueValueType.Stat, 'nimble_warrior_reaper_effect_crit_damage_percent');
            overrideValueTypeAndStat(ba, 1, EffectValueValueType.Stat, 'nimble_warrior_reaper_effect_brut_damage_percent');
            overrideValueTypeAndStat(ba, 2, EffectValueValueType.Stat, 'nimble_warrior_reaper_effect_crit_chance_percent');
            overrideValueTypeAndStat(ba, 3, EffectValueValueType.Stat, 'nimble_warrior_reaper_effect_brut_chance_percent');
    ...
    79: {
        override: (ba, be, ma, reaperId) => {
            ...
            overrideValueTypeAndStat(ba, 0, EffectValueValueType.Stat, 'chrysalis_reaper_effect_elemental_damage_percent');
    ...
    82: {
        override: (ba, be, ma, reaperId) => {
            overrideValueTypeAndStat(ba, 0, EffectValueValueType.Stat, 'ancestral_legacy_reaper_buff_legacy_brut_chance');
        }
    },
    83: {
        override: (ba, be, ma, reaperId) => {
            overrideValueTypeAndStat(ba, 0, EffectValueValueType.Duration, 'ancestral_legacy_reaper_buff_fervor_duration');
            overrideValueTypeAndStat(ba, 1, EffectValueValueType.Stat, 'ancestral_legacy_reaper_buff_fervor_elemental_damages');
        }
    },
    98: {
        override: (ba, be, ma, reaperId) => {
    ...
    118: {
        override: (ba, be, ma, reaperId) => {
            ...
            overrideValueTypeAndStat(ba, 2, EffectValueValueType.Stat, 'rising_sun_reaper_light_imbued_increased_damage');
